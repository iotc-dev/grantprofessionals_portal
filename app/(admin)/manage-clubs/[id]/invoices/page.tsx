...
// ── Sample data for Ryde Saints JFC ──
const clubName = "Ryde Saints JFC";
...
// ── Page ──
export default function ClubInvoicesAdmin() {
  return (
    <div>
      <Breadcrumb items={[
        { label: "Dashboard", href: "/admin-dashboard" },
        { label: "Manage Clubs", href: "/manage-clubs" },
        { label: clubName, href: "/manage-clubs/rs" },
        { label: "Invoices" },
      ]} />
      ...
      <Card>
        <CardHeader
          title={`Invoices — ${clubName}`}
          actions={
            <Link href="/manage-clubs/rs" className="no-underline">
              <Button
                icon={
