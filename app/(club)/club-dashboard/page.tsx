...
// --- Sample Club Data (same as admin view — will come from Supabase later) ---
...
export default function ClubDashboard() {
  ...
  return (
    <div>
      {/* No breadcrumb — this is the landing page */}
        ...
        <div className="p-4 md:p-8">
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
            ...
            <div className="flex gap-3">
              <Link href="/club-dashboard/edit" className="no-underline">
                <Button icon={EditIcon}>Edit Club Details</Button>
              </Link>
                <Link href="/club-dashboard/invoices" className="no-underline">
